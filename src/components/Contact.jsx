...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("access_key", "7f5deecf-beb5-46a9-b777-cd3d519917f6");
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:53srao786@gmail.com" target="_blank" rel="noreferrer" className="blue-text-gradient">53srao786@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918435510384&text&app_absent=0&lang=en" target="_blank" rel="noreferrer" className="blue-text-gradient">
              +91 8435510384
            </a>
          </article>
        </div>
