        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm <p className="name text-[#915EFF]">Shamoil Rao</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a
                href="https://github.com/ShamoilRao44"
                target="_blank"
                rel="noreferrer"
              >
                <AiOutlineGithub />
              ...
              <a
                href="https://www.linkedin.com/in/shamoilrao"
                target="_blank"
                rel="noreferrer"
              >
                <ImLinkedin />
